    ...
    <section class="py-16 bg-gradient-to-r from-primary to-primary/80 text-white">
      <div class="container mx-auto px-4">
        <div class="text-center mb-8">
          <h2 class="text-4xl font-bold mb-4">Ограниченное предложение</h2>
          <p class="text-xl mb-8">Получите дополнительную скидку 10% на любой матрас</p>
        ...
        <Transition name="modal">
          <div v-if="showOfferModal" class="bg-white rounded-lg p-8 max-w-md w-full mx-4 my-8">
            <div class="flex justify-between items-center mb-6">
              <h3 class="text-2xl font-semibold text-gray-900">Получите скидку 10%</h3>
